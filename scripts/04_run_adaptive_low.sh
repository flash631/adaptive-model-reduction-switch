...
LOG="${LOG_DIR}/04_run_adaptive_low_${ts}.log"
...
log "Running adaptive driver (FOM/ROM switching)..."
python "${ROOT_DIR}/rom/python/adaptive_driver.py" --config "${CONFIG}" --force 2>&1 | tee -a "${LOG}"
